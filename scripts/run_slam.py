...
from src.GS_SLAM.evaluation.evaluator import Evaluator
from src.GS_SLAM.utils.io_utils import load_config, log_metrics_to_wandb
from src.GS_SLAM.utils.utils import setup_seed


def get_args():
    parser = argparse.ArgumentParser(
        description='Arguments to compute the mesh')
    parser.add_argument('--config_path', default='configs/demoroom/demoroom.yaml', type=str,

...
class CARLA2NMR_App:
    ...
    def __init__(self):
        ...
        if gui.Application.instance.menubar is None:
            ...
            debug_menu = gui.Menu()
            debug_menu.add_item("Add Sphere", CARLA2NMR_App.MENU_SPHERE)
            debug_menu.add_item("Add Random Spheres", CARLA2NMR_App.MENU_RANDOM)
            if not isMacOS:
                debug_menu.add_separator()
                debug_menu.add_item("Quit", CARLA2NMR_App.MENU_QUIT)
        ...
        self.window.set_on_menu_item_activated(CARLA2NMR_App.MENU_SPHERE,
                                               self._on_menu_sphere)
        self.window.set_on_menu_item_activated(CARLA2NMR_App.MENU_RANDOM,

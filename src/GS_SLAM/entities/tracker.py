...
from src.GS_SLAM.entities.losses import l1_loss
from src.GS_SLAM.entities.gaussian_model import GaussianModel
from src.GS_SLAM.entities.logger import Logger
from src.GS_SLAM.entities.datasets import BaseDataset
from src.GS_SLAM.entities.visual_odometer import VisualOdometer
from src.GS_SLAM.utils.gaussian_model_utils import build_rotation
from src.GS_SLAM.utils.tracker_utils import (compute_camera_opt_params,
...
class Tracker(object):
    def __init__(self, config: dict, dataset: BaseDataset, logger: Logger) -> None:
        ...
        self.odometer = VisualOdometer(self.dataset.get_intrinsics(0), self.config["odometer_method"])
